...
export default function Brand() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-[var(--glass)] backdrop-blur-md border-b border-white/10">
      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          <aside className="absolute right-0 top-0 h-full w-[78%] max-w-sm bg-[var(--glass)] backdrop-blur-md border-l border-white/10 p-4">
