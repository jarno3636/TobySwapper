...
const sites = [
  ...
  },
  {
    ...
    copy: "Community speculation profiles, consensus theories, predictions, reactions and Toad Gang history.",
    mark: "◇",
  },
  {
    name: "Toad Merch",
...
export default function CommunitySites() {
  return (
    <section className={styles.shell} aria-labelledby="community-sites-title">
      <header className={styles.heading}>
        <div>
          <span className="land-section-kicker">BEYOND THIS POND</span>
          <h2 id="community-sites-title">The wider Tobyworld.</h2>
          <p>
            Official lore and community-built places worth carrying with you.
          </p>
        </div>

        <span className={styles.fieldNote}>COMMUNITY PATHS</span>
      </header>
      ...
      <div className={styles.grid}>
        {sites.map((site) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={`${styles.card} ${site.featured ? styles.featured : ""}`}
          >
