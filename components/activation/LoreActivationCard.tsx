...
import type {
  ActivationLock,
} from "@/hooks/useLoreActivationReads";

import {
  activationBaseScanTx,
} from "@/lib/activation-contracts";

import type {
  ActivationStage,
} from "@/hooks/useLoreActivationActions";
...
export default function LoreActivationCard(
  props: {
    tokenId: string;
    name?: string | null;
    owner?: Address;
  ...
  const enoughPatience =
    props.patienceBalance >=
    props.yCost;
  ...
  /*
   * isActive(tokenId) remains
   * canonical truth.
   *
   * The nonce comparison is
   * informational only.
   */
  ...
  return (
    ...
    >
          ...
          {props.lock ? (
            <div className="activation-lock-generation">
              <span>
                ...
                GENERATION{" "}
                <strong>
                  {props.lock.ownershipNonceAtActivation.toString()}
                </strong>
              </span>
      ...
      labels[
        ...
        <div
          className={`activation-stage ${props.stage}`}
        >
          <i />
