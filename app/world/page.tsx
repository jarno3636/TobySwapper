    ...
    <MiniAppGate>
      <main className="world-page mx-auto w-full max-w-6xl px-4 pb-32 pt-4 sm:px-6 sm:pt-6">
        ...
        <section className="world-hero">
          <div className="world-hero-copy"><span className="land-section-kicker">THE COMMUNITY ATLAS</span><h1>World</h1><p>Every deed can become a place worth visiting. Wander named lands, follow community trails, or open any Lore Deed by number.</p><div className="world-hero-actions"><a href="#atlas">Explore lands ↓</a><Link prefetch={false} href="/taboshi1#land">Find my land</Link></div></div>
