    ...
    <MiniAppGate>
      <main className="exchange-page mx-auto w-full max-w-6xl px-4 pb-32 pt-4 sm:px-6 sm:pt-6">
        ...
        <section className="exchange-hero exchange-hero-clean">
          <div className="exchange-hero-copy"><span className="land-section-kicker">THE MARKET GATE</span><h1>Tobyworld Market</h1><p>One clean market for SEED, Old Lore Land, and Canonical Lore Land. Browse what is for sale or post what you are looking for.</p><div className="exchange-hero-actions"><a href="#market">Open market ↓</a><a href="/taboshi1#pouch">My assets</a></div></div>
