...
// Universal Router (v4) on Base — for your reference / future use
export const UNIVERSAL_ROUTER_V4: Address = "0x6ff5693b99212da76ad316178a184ab56d299b43" as const;

// Permit2 (used by Universal Router when swapping directly from EOAs)
export const PERMIT2: Address = "0x000000000022d473030f116ddee9f6b43ac78ba3" as const;
