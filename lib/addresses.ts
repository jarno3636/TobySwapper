...
// Explicitly type these as Set<string> so .has() works with any string
export const ALLOWED_BASES: Set<string> = new Set<string>([
  ADDR.USDC,
  ADDR.WETH,
])

export const ALLOWED_COMMODITIES: Set<string> = new Set<string>([
  ADDR.TOBY,
  ADDR.PATIENCE,
  ADDR.TABOSHI,
])
